...
<main class="sm:container sm:mx-auto sm:mt-10">
    <form action="{{ route('games.store') }}" method="post" enctype="multipart/form-data" class="w-full py-6  sm:p-6 flex flex-col space-y-4">
      @csrf  
      <div>
        ...
        <div>
            <label for="short-desc" class="block text-sm font-medium text-gray-700">
              ...
              <div class="mt-1">
                  <textarea name="short_desc" id="short-desc" cols="30" rows="3" required class="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"></textarea>
        ...
        <div>
            <label for="long-desc" class="block text-sm font-medium text-gray-700">
              ...
              <div class="mt-1">
                  <textarea name="long_desc" id="long-desc" cols="30" rows="10" required class="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"></textarea>
        ...
        <div>
            <label for="developer" class="block text-sm font-medium text-gray-700">
                Game Developer
              </label>
              <div class="mt-1">
                <input id="developer" name="developer" type="text" required class="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
              </div>
        </div>
        <div>
            <label for="publisher" class="block text-sm font-medium text-gray-700">
              ...
              <div class="mt-1">
                <input id="publisher" name="publisher" type="text" required class="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
              </div>
        </div>
        <div>
            <label for="price" class="block text-sm font-medium text-gray-700">
              ...
              <div class="mt-1">
                <input id="price" name="price" type="number" required class="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
              </div>
        </div>
        <div>
        ...
        <div>
            <div class="flex items-center">
              <input id="restrict" name="restrict" type="checkbox" class="form-checkbox h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded">
              <label for="restrict" class="ml-2 block text-sm text-gray-900">
                Only for adult ?
              </label>
            </div>
        </div>
