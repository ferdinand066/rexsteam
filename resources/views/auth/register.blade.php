        ...
        <div class="w-full">
            <section class="flex flex-col break-words bg-white sm:border-1 sm:rounded-md sm:shadow-sm sm:shadow-lg">
                ...
                <form class="w-full px-6 space-y-6 sm:px-10 sm:space-y-8" method="POST"
                    ...
                    <div class="flex flex-wrap">
                        <label for="full_name" class="block text-gray-700 text-sm font-bold mb-2 sm:mb-4">
                            {{ __('Full Name') }}:
                        </label>
                    ...
                    <div class="flex flex-wrap">
                        ...
                        <select id="role" name="role" required class="form-select w-full @error('role') border-red-500 @enderror">
